...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchFilter :  IEquatable<SearchFilter>
    { 
        ...
        public SearchFilter(List<string> MustNot = null, List<string> Should = null, List<string> Must = null)
        {
        ...
        /// </summary>
        /// <param name="other">Instance of SearchFilter to be compared</param>
        /// <returns>Boolean</returns>
