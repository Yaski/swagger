...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Write :  IEquatable<Write>
    { 
        ...
        public Write(Allow Allow = null, Deny Deny = null)
        {
            this.Allow = Allow;
            this.Deny = Deny;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Write);
        }

        /// <summary>
        /// Returns true if Write instances are equal
        /// </summary>
        /// <param name="other">Instance of Write to be compared</param>
        /// <returns>Boolean</returns>
