...
import io.cloudboost.auth.Authentication;
import io.cloudboost.auth.HttpBasicAuth;
import io.cloudboost.auth.ApiKeyAuth;
import io.cloudboost.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "http://api.cloudboost.io/";
