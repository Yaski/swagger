...
module SwaggerClient
  class ModifiedQueue
    ...
    attr_accessor :_is_modified

    attr_accessor :_modified_columns
    ...
    def self.swagger_types
      {
        ...
        :'_modified_columns' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'_isModified']
        self._is_modified = attributes[:'_isModified']
      else
        self._is_modified = true
      end
      
      if attributes[:'_modifiedColumns']
        if (value = attributes[:'_modifiedColumns']).is_a?(Array)
          self._modified_columns = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _is_modified == o._is_modified &&
          _modified_columns == o._modified_columns &&
          messages == o.messages
    end
    ...
    def hash
      [acl, _type, expires, queue_type, _retry, name, subscribers, _is_modified, _modified_columns, messages].hash
    end
