...
# Unit tests for SwaggerClient::CacheRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CacheRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::CacheRequest.new
  end
  ...
  describe 'test an instance of CacheRequest' do
    it 'should create an instact of CacheRequest' do
      @instance.should be_a(SwaggerClient::CacheRequest) 
    end
  end
