...
# Unit tests for SwaggerClient::CloudSearch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloudSearch' do
  before do
    # run before each test
    @instance = SwaggerClient::CloudSearch.new
  end
  ...
  describe 'test an instance of CloudSearch' do
    it 'should create an instact of CloudSearch' do
      @instance.should be_a(SwaggerClient::CloudSearch) 
    end
  end
