...
#ifndef SamiCloudQuery_H_
#define SamiCloudQuery_H_
...
class SamiCloudQuery: public SamiObject {
public:
    SamiCloudQuery();
    SamiCloudQuery(String* json);
    virtual ~SamiCloudQuery();
    ...
    SamiCloudQuery* fromJson(String* obj);
